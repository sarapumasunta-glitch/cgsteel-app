...
import { addServiceImages } from "./actions";
import MultiImageDropzone, { type PendingImage } from "@/components/admin/MultiImageDropzone";

export default function AddServicePhotosForm({ serviceId }: { serviceId: string }) {
  ...
  async function handleSubmit(e: React.FormEvent) {
    ...
    try {
      ...
      const result = await addServiceImages(serviceId, formData);
      if (result?.error) {
